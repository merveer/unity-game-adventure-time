	...
	public abstract class CharacterMovement : MonoBehaviour {
		...
		protected virtual void FixedUpdate () {
			...
			Rig.linearVelocity = new Vector2(
				AimSpeed,
				Mathf.Clamp(Rig.linearVelocity.y, -MAX_DROP_SPEED, MAX_DROP_SPEED)
			);
		...
		public void Jump () {
			if (m_CurrentJumpCount < m_JumpCount) {
				...
				Rig.linearVelocity = new Vector2(Rig.linearVelocity.x, m_JumpSpeed);
